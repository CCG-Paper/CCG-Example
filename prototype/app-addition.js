...
class View {
    constructor(template, listHtmlClass) {
        this.template = template;
        this.listHtmlClass = listHtmlClass;
    
        this.$todoList = qs("." + listHtmlClass + " .todo-list");
        this.$todoItemCounter = qs("." + listHtmlClass + " .todo-count");
        this.$clearCompleted = qs("." + listHtmlClass + " .clear-completed");
        this.$main = qs("." + listHtmlClass + " .main");
        this.$footer = qs("." + listHtmlClass + " .footer");
        this.$toggleAllInput = qs("." + listHtmlClass + " .toggle-all");
        this.$toggleAll = qs("." + listHtmlClass + " .toggle-all-label");
        this.$newTodo = qs("." + listHtmlClass + " .new-todo");
